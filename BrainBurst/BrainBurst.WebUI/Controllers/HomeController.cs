...
public class HomeController : Controller
{
    ...
    {
        // === ОСЬ ЦЯ ПЕРЕВІРКА ВИРІШИТЬ ПРОБЛЕМУ ===
        // Якщо користувач вже авторизований, одразу кидаємо його в додаток
        if (User.Identity != null && User.Identity.IsAuthenticated)
        {
            return RedirectToAction("Index", "Cards"); // Перекидаємо на сторінку карток
        }
