...
* 
### Системні вимоги:
- **Тип додатку**: Веб-сайт (Web Application).
- **Клієнт**: Будь-який пристрій з доступом до інтернету та веб-браузером.
- **Сервер**: Підтримка .NET 8 Runtime, доступ до SQL Server та з'єднання з OpenAI API через HTTPS.
